...
* Proportion: The (approximate) proportion of babies born with this name in this decade, as calculated from this database. This is written in "scientific notation" since the numbers are small. For example, "6.2e-06" means 6.2 times 10^-6, or 6.2 babies per million.
